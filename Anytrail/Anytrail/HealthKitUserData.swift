...
class HealthKitUserData {
    ...
    let beginningDay = NSCalendar.currentCalendar().startOfDayForDate(NSDate()) ?? NSDate()
    ...
    func getStepCountForToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(stepCountType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.countUnit()) { stepCountSum in
    ...
    func getBasalEnergyForToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(basalEnergyType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.calorieUnit()) { basalEnergySum in
    ...
    func getFlightCountForToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(flightClimbedType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.countUnit()) { flightClimbedSum in
    ...
    func getDistanceForToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(distanceWalkedType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.mileUnit()) { distanceWalkedSum in
    ...
    func getExerciseForToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(exerciseTimeType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.minuteUnit()) { exerciseTimeSum in
    ...
    func getActiveEnergyForToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(activeEnergyType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.calorieUnit()) { activeEnergySum in
    ...
    func getWaterConsumptionToday(completion: (Double?) -> Void) {
        ...
        HealthKitDataStore.sharedInstance.sumOfData(waterConsumedType, fromDate: beginningDay, toDate: currentDate, statisticOptions: .CumulativeSum, unitType: HKUnit.literUnit()) { waterConsumedSum in
